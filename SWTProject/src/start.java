...
public class start {
    ...
    public static void main(String[] args) {
        ...
        URI uri = URI.createURI("model\\Test_papyrus.uml");
        ...
        for (Property property : clazz.getAllAttributes()) {
            if (property.getAssociation() != null) {
                ...
                if (sourceEnd.getAggregation() == AggregationKind.COMPOSITE_LITERAL) {
                    ret.append(sourceEnd.getType().getName()).append(" \"1\" *-- \"many\" ")
                            .append(targetEnd.getType().getName()).append(" : contains\n");
                }
                // Check for Aggregation
                    ...
                    String associationName = association.getName() != null ? association.getName()
                            : targetEnd.getType().getName();
                    ret.append(sourceEnd.getType().getName()).append(" o-- ").append(targetEnd.getType().getName())
                            .append(" : <<").append(associationName).append(">>\n");
                }
                // Regular Association
                else {
                    ret.append(sourceEnd.getType().getName()).append(" --> \"1\" ").append(targetEnd.getType().getName())
                            .append("\n");
                }
            }
        }
